...
all.Skill_YLMGZhu_Unique = {
	__new__ = function (prototype, externs, global)
		...
		assert(this.ExRateFactor ~= nil, "External variable `ExRateFactor` is not provided.")
...
all.Skill_YLMGZhu_Unique_Awaken = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
		...
		this.dmgUpRate = externs.dmgUpRate

		if this.dmgUpRate == nil then
			this.dmgUpRate = 0.3
		end
