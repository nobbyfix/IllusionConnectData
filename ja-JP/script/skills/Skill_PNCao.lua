...
all.Skill_PNCao_Passive_Death = {
	...
	main = function (_env, externs)
		...
		exec["@time"]({
			...
			local this = _env.this
			local global = _env.global
			local SummonedPNCaoA = global.Summon(_env, _env.ACTOR, "SummonedPNCao_NuoNuo", this.summonFactorA, nil, {
				2,
				5,
				1,
				3,
			...
			if SummonedPNCaoA then
				global.AddStatus(_env, SummonedPNCaoA, "SummonedPNCao")
			end

			local SummonedPNCaoB = global.Summon(_env, _env.ACTOR, "SummonedPNCao_HuaHaiJi", this.summonFactorB, nil, {
				7,
				8,
				9,
				4,
			...
			if SummonedPNCaoB then
				global.AddStatus(_env, SummonedPNCaoB, "SummonedPNCao")
			end
		end)
...
all.Skill_PNCao_NuoNuo_Passive_Death = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.Skill_PNCao_HuaHaiJi_Normal = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.Skill_PNCao_HuaHaiJi_Proud = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.Skill_PNCao_Passive_Death_EX = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
