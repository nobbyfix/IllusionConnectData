...
all.Skill_LCYShi_Proud = {
	__new__ = function (prototype, externs, global)
		...
		this.main = global["[load]"](this, {
			"Movie_LCYShi_Skill2_F",
			"Movie_LCYShi_Skill2_B"
		}, main)
