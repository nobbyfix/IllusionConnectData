ActivitySunflowerMainMediator = class("ActivitySunflowerMainMediator", DmAreaViewMediator, _M)

ActivitySunflowerMainMediator:has("_activitySystem", {
	is = "r"
}):injectWith("ActivitySystem")
ActivitySunflowerMainMediator:has("_developSystem", {
	is = "r"
}):injectWith("DevelopSystem")
ActivitySunflowerMainMediator:has("_surfaceSystem", {
	is = "r"
...
local KMapIds = {
	"ActivityBlock_Sunflower_Map"
}

function ActivitySunflowerMainMediator:initialize()
...
function ActivitySunflowerMainMediator:dispose()
	self:stopTimer()
	super.dispose(self)
end

function ActivitySunflowerMainMediator:stopTimer()
...
function ActivitySunflowerMainMediator:onRegister()
...
function ActivitySunflowerMainMediator:setTimerString(timeStr, timeTip, key)
...
function ActivitySunflowerMainMediator:initView()
	self:initInfo()
	self:initTimer()
	self:initRoleTimer()
...
function ActivitySunflowerMainMediator:playBackgroundMusic()
	local bgm = self._activity:getBgm()

	AudioEngine:getInstance():playBackgroundMusic(bgm)
end

function ActivitySunflowerMainMediator:initInfo()
	...
	if not self._stageAnim then
		self._stageAnim = cc.MovieClip:create("eff_zong_kaiqixinjianeff")

		self._stageAnim:setPosition(cc.p(160, 129))
...
function ActivitySunflowerMainMediator:getStatus(mapId)
...
function ActivitySunflowerMainMediator:initTimer()
...
function ActivitySunflowerMainMediator:initRoleTimer()
	if self._roleTimer then
		self._roleTimer:stop()
	end
...
function ActivitySunflowerMainMediator:updateRolePanel()
...
function ActivitySunflowerMainMediator:onClickBack(sender, eventType)
	self:dismiss()
end

function ActivitySunflowerMainMediator:onClickStage(sender)
...
function ActivitySunflowerMainMediator:onClickAttrAdd()
...
function ActivitySunflowerMainMediator:onClickRule()
...
function ActivitySunflowerMainMediator:onClickTask()
...
function ActivitySunflowerMainMediator:onClickTeam()
	local start = false
	local over = true
...
function ActivitySunflowerMainMediator:onClickEgg()
...
function ActivitySunflowerMainMediator:onClickSurface()
...
function ActivitySunflowerMainMediator:onClickLeft()
...
function ActivitySunflowerMainMediator:onClickRight()
	if not self._canChangeHero then
		return
	end
...
function ActivitySunflowerMainMediator:updateStage()
...
function ActivitySunflowerMainMediator:playStageAnim()
...
function ActivitySunflowerMainMediator:onClickRolePanel()
	local model = self._roles[self._roleIndex].model
	local type_ = self._roles[self._roleIndex].type
