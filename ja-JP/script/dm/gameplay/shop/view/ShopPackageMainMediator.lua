...
function ShopPackageMainMediator:initMember()
	...
	self._refreshBg = self._refreshPanel:getChildByFullName("refreshBg")

	self._refreshBg:setContentSize(cc.size(self._refreshDesc:getVirtualRenderer():getContentSize().width * 2, 25))
