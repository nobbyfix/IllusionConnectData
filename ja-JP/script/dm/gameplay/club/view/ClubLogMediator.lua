...
function ClubLogMediator:createTableView()
	...
	local function tableCellAtIndex(table, idx)
		...
		if hasTitle then
			...
			image:addTo(mainLayout):posite(80, mainLayout:getContentSize().height - 30)
			...
			dateLabel:addTo(mainLayout):posite(66, mainLayout:getContentSize().height - 20)
...
function ClubLogMediator:getRichText(idx)
	...
	if size.width > 650 then
		descLabel:renderContent(650, 0)
	end
