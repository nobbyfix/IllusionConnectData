...
function TaskAchieveMediator:onRegister()
	...
	self._tabClone:getChildByFullName("dark_1.text"):setTextAreaSize(cc.size(99, 42))
	self._tabClone:getChildByFullName("light_1.text"):setTextAreaSize(cc.size(99, 42))
