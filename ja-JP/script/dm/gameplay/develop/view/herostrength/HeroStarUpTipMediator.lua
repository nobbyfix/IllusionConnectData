...
function HeroStarUpTipMediator:createUI(data)
	...
	attrPanel:getChildByFullName("des_1.extandText"):setString("+" .. attack - data.attr.attack[1])
	attrPanel:getChildByFullName("des_2.extandText"):setString("+" .. hp - data.attr.hp[1])
	attrPanel:getChildByFullName("des_3.extandText"):setString("+" .. defense - data.attr.defense[1])
	attrPanel:getChildByFullName("des_4.extandText"):setString("+" .. speed - data.attr.speed[1])
