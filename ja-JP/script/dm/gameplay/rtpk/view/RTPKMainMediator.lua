...
function RTPKMainMediator:onRegister()
	...
	self:getView():getChildByName("btn_rule"):offset(70, 0)
end
...
function RTPKMainMediator:setSeasonInfo()
	...
	local text1 = self._seasonPanel:getChildByName("Text_14")
	local text2 = self._seasonPanel:getChildByName("Text_season_2")

	text1:setAnchorPoint(cc.p(0, 0.5))
	text2:setAnchorPoint(cc.p(0, 0.5))
	text1:setPositionX(indexText:getPositionX() + indexText:getContentSize().width * 0.5)
	text2:setPositionX(text1:getPositionX())
	nameText:setPositionX(text1:getPositionX() + text1:getContentSize().width + 20)
	nameText2:setPositionX(nameText:getPositionX())
...
function RTPKMainMediator:setSeasonRule()
	...
	ruleBtn:setPositionX(self._rulePanel:getChildByName("Text_18"):getPositionX() + self._rulePanel:getChildByName("Text_18"):getContentSize().width + 20)
