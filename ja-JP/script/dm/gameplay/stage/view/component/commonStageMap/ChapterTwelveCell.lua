ChapterTwelveCell = class("ChapterTwelveCell", ChapterBase)
local kBtnHandlers = {}
local onPlayAnim = nil

function ChapterTwelveCell:initialize(data)
...
function ChapterTwelveCell:update(stageType, redPointTab)
	...
	self:initChapterPanel(self._chapter1, "M22", callFunc)
	...
	self:initChapterPanel(self._chapter2, "M23", callFunc)
...
function ChapterTwelveCell:initView()
	self:initWidget()
	self:initAnim()
end

function ChapterTwelveCell:initWidget()
...
function ChapterTwelveCell:initAnim()
