...
function scene_story08_1a:stage(args)
	return {
		...
		children = {
			...
			{
				id = "Voice_Story_NDGEr_01",
				fileName = "Voice_Story_NDGEr_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_NDGEr_02",
				fileName = "Voice_Story_NDGEr_02",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_12",
				fileName = "Voice_Story_FEMSi_12",
				type = "Sound"
			},
			{
...
function scene_story08_1a.actions.start_story08_1a(_root, args)
	return sequential({
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_NDGEr_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_NDGEr_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_12")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			...
			args = function (_ctx)
				return {
					blockId = "Mus_Story_Common_1_1_Block_1"
				}
			end
		}),
		act({
		...
		concurrent({
			act({
				action = "updateNode",
				actor = __getnode__(_root, "Sister_ZTXChang"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		act({
			...
			args = function (_ctx)
				return {
					blockId = "Mus_Story_Yehuo_Normal_Block_1"
				}
			end
		}),
		act({
