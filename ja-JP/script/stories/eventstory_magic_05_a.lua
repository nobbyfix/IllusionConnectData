...
module("storysandbox.eventstory_magic_05_a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_magic_05_a = {
	actions = {}
}
scenes.scene_eventstory_magic_05_a = scene_eventstory_magic_05_a

function scene_eventstory_magic_05_a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_magic_05_a.actions.start_eventstory_magic_05_a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
local function eventstory_magic_05_a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_magic_05_a",
					scene = scene_eventstory_magic_05_a
				}
			end
		})
	})
...
stories.eventstory_magic_05_a = eventstory_magic_05_a
