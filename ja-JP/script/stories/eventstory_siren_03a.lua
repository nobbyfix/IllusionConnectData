...
module("storysandbox.eventstory_siren_03a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_siren_03a = {
	actions = {}
}
scenes.scene_eventstory_siren_03a = scene_eventstory_siren_03a

function scene_eventstory_siren_03a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_siren_03a.actions.start_eventstory_siren_03a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		concurrent({
			act({
				...
				args = function (_ctx)
					return {
						content = {
							"eventstory_siren_03a_1",
							{
								"eventstory_siren_03a_2",
								"eventstory_siren_03a_3",
								"eventstory_siren_03a_4",
								"eventstory_siren_03a_5"
							}
						}
					}
				end
		...
		act({
			...
			args = function (_ctx)
				return {
					...
					heightSpace = 12,
					content = {
						"eventstory_siren_03a_6",
						"eventstory_siren_03a_7",
						"eventstory_siren_03a_8",
						"eventstory_siren_03a_9"
					},
					waitTimes = {
						5
					}
...
local function eventstory_siren_03a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_siren_03a",
					scene = scene_eventstory_siren_03a
				}
			end
		})
	})
...
stories.eventstory_siren_03a = eventstory_siren_03a
