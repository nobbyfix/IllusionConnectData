...
function scene_story13_1a.actions.start13_1a1(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story13_1a.actions.start13_1a2(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "ZTXChang_face"),
...
function scene_story13_1a.actions.start13_1a3(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "ZZBBWei/ZZBBWei_face_6.png",
					pathType = "STORY_FACE"
				}
			end
		}),
