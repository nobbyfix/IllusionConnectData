...
module("storysandbox.ministory_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_ministory_3a = {
	actions = {}
}
scenes.scene_ministory_3a = scene_ministory_3a

function scene_ministory_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_ministory_3a.actions.start_ministory_3a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "addPortrait",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "ministory_dialog_speak_name_2",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "ministory_dialog_speak_name_3",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
...
local function ministory_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_ministory_3a",
					scene = scene_ministory_3a
				}
			end
		})
	})
...
stories.ministory_3a = ministory_3a
