...
module("storysandbox.eventstory_zuohe_02a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_zuohe_02a = {
	actions = {}
}
scenes.scene_eventstory_zuohe_02a = scene_eventstory_zuohe_02a

function scene_eventstory_zuohe_02a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_zuohe_02a.actions.start_eventstory_zuohe_02a(_root, args)
	return sequential({
		act({
			action = "activateNode",
...
local function eventstory_zuohe_02a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_zuohe_02a",
					scene = scene_eventstory_zuohe_02a
				}
			end
		})
	})
...
stories.eventstory_zuohe_02a = eventstory_zuohe_02a
