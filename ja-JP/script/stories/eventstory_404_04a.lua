...
module("storysandbox.eventstory_404_04a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_404_04a = {
	actions = {}
}
scenes.scene_eventstory_404_04a = scene_eventstory_404_04a

function scene_eventstory_404_04a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_404_04a.actions.start_eventstory_404_04a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
		...
		concurrent({
			...
			act({
				...
				args = function (_ctx)
					return {
						name = "404Riddle_dialog_speak_name_11",
						dialogImage = "jq_dialogue_bg_1.png",
						location = "left",
						pathType = "STORY_ROOT",
						speakings = {
...
local function eventstory_404_04a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_404_04a",
					scene = scene_eventstory_404_04a
				}
			end
		})
	})
...
stories.eventstory_404_04a = eventstory_404_04a
