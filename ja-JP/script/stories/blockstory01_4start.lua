...
module("storysandbox.blockstory01_4start")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_blockstory01_4start = {
	actions = {}
}
scenes.scene_blockstory01_4start = scene_blockstory01_4start

function scene_blockstory01_4start:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_blockstory01_4start.actions.start_blockstory01_4start(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "story_baozha")
		}),
		act({
			action = "play",
...
local function blockstory01_4start(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_blockstory01_4start",
					scene = scene_blockstory01_4start
				}
			end
		})
	})
...
stories.blockstory01_4start = blockstory01_4start
