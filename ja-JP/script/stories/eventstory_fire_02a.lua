...
module("storysandbox.eventstory_fire_02a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_fire_02a = {
	actions = {}
}
scenes.scene_eventstory_fire_02a = scene_eventstory_fire_02a

function scene_eventstory_fire_02a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_fire_02a.actions.start_eventstory_fire_02a(_root, args)
	return sequential({
		sleep({
			args = function (_ctx)
				return {
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "xiao_huiyib"),
				args = function (_ctx)
					return {
						time = -1
					}
...
local function eventstory_fire_02a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_fire_02a",
					scene = scene_eventstory_fire_02a
				}
			end
		})
	})
...
stories.eventstory_fire_02a = eventstory_fire_02a
