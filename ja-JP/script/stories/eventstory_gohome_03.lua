...
module("storysandbox.eventstory_gohome_03")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_gohome_03 = {
	actions = {}
}
scenes.scene_eventstory_gohome_03 = scene_eventstory_gohome_03

function scene_eventstory_gohome_03:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_gohome_03.actions.start_eventstory_gohome_03(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
local function eventstory_gohome_03(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_gohome_03",
					scene = scene_eventstory_gohome_03
				}
			end
		})
	})
...
stories.eventstory_gohome_03 = eventstory_gohome_03
