...
module("storysandbox.eventstory_404_02a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_404_02a = {
	actions = {}
}
scenes.scene_eventstory_404_02a = scene_eventstory_404_02a

function scene_eventstory_404_02a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_404_02a.actions.start_eventstory_404_02a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_gongju"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			act({
				action = "fadeIn",
				actor = __getnode__(_root, "bg_xiashuidao"),
				args = function (_ctx)
					return {
						duration = 0
					}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_shufang"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			act({
				action = "fadeIn",
				actor = __getnode__(_root, "CG_bangjia2"),
				args = function (_ctx)
					return {
						duration = 0
					}
...
local function eventstory_404_02a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_404_02a",
					scene = scene_eventstory_404_02a
				}
			end
		})
	})
...
stories.eventstory_404_02a = eventstory_404_02a
