...
module("storysandbox.eventstory_magic_05_c")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_magic_05_c = {
	actions = {}
}
scenes.scene_eventstory_magic_05_c = scene_eventstory_magic_05_c

function scene_eventstory_magic_05_c:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_magic_05_c.actions.start_eventstory_magic_05_c(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
local function eventstory_magic_05_c(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_magic_05_c",
					scene = scene_eventstory_magic_05_c
				}
			end
		})
	})
...
stories.eventstory_magic_05_c = eventstory_magic_05_c
