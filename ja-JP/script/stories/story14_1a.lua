...
function scene_story14_1a.actions.start14_1a1(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story14_1a.actions.start14_1a2(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story14_1a.actions.start_story14_1a3(_root, args)
	return sequential({
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "curtain"),
