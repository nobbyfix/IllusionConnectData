...
module("storysandbox.story03_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story03_3a = {
	actions = {}
}
scenes.scene_story03_3a = scene_story03_3a

function scene_story03_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Voice_Story_XLai_09",
				fileName = "Voice_Story_XLai_09",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_XLai_10",
				fileName = "Voice_Story_XLai_10",
				type = "Sound"
			},
			{
				id = "Voice_Story_LDu_01",
				fileName = "Voice_Story_LDu_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_XLai_11",
				fileName = "Voice_Story_XLai_11",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_MLYTLSha_02",
				fileName = "Voice_Story_MLYTLSha_02",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_10",
				fileName = "Voice_Story_ZTXChang_10",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_CLMan_06",
				fileName = "Voice_Story_CLMan_06",
				type = "Sound"
			}
		},
...
function scene_story03_3a.actions.start_story03_3a(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_Story_Moli"),
			args = function (_ctx)
				return {
					isLoop = true
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_XLai_09")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "movie1"),
			args = function (_ctx)
				return {
					time = 1,
					delay = 0.3
		...
		act({
			action = "play",
			actor = __getnode__(_root, "movie2"),
			args = function (_ctx)
				return {
					time = 1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "particle1"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_XLai_10")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_LDu_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_XLai_11")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
					...
					children = {
						{
							...
							name = "MLYTLSha_face",
							type = "Image",
							image = "asset/story/face/MLYTLSha/MLYTLSha_face_1.png",
							layoutMode = 1,
							scaleY = 1,
							zorder = 1100,
							visible = true,
...
function scene_story03_3a.actions.start_story03_3b(_root, args)
	return sequential({
		act({
			action = "fadeOut",
			actor = __getnode__(_root, "XLai_speak"),
...
function scene_story03_3a.actions.start_story03_3c(_root, args)
	return sequential({
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "CLMan_speak"),
...
function scene_story03_3a.actions.start_story03_3d(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "XLai_face"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_XLai_12")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_MLYTLSha_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_10")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_CLMan_06")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story03_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story03_3a",
					scene = scene_story03_3a
				}
			end
		})
	})
