...
module("storysandbox.eventstory_zuohe_10a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_zuohe_10a = {
	actions = {}
}
scenes.scene_eventstory_zuohe_10a = scene_eventstory_zuohe_10a

function scene_eventstory_zuohe_10a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_zuohe_10a.actions.start_eventstory_zuohe_10a(_root, args)
	return sequential({
		act({
			action = "activateNode",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_Zuohe_2"),
			args = function (_ctx)
				return {
					isLoop = true
				}
...
local function eventstory_zuohe_10a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_zuohe_10a",
					scene = scene_eventstory_zuohe_10a
				}
			end
		})
	})
...
stories.eventstory_zuohe_10a = eventstory_zuohe_10a
