...
function scene_story18_2a.actions.start_story18_2a(_root, args)
	return sequential({
		act({
			action = "activateNode",
			actor = __getnode__(_root, "bg_yanchanghui")
		}),
		act({
			action = "fadeIn",
		...
		concurrent({
			act({
				...
				args = function (_ctx)
					return {
						name = "NS16_19_dialog_speak_name_11",
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_yinyun"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "YuMin1"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				action = "orbitCamera",
				actor = __getnode__(_root, "YuMin2"),
				args = function (_ctx)
					return {
						angleZ = 0,
						time = 0,
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "YuMin3"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "YuMin4"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				...
				args = function (_ctx)
					return {
						name = "NS16_19_dialog_speak_name_16",
						dialogImage = "jq_dialogue_bg_1.png",
						location = "left",
						pathType = "STORY_ROOT",
						speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NS16_19_dialog_speak_name_17",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
