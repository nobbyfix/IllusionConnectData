...
module("storysandbox.story18_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story18_2a = {
	actions = {}
}
scenes.scene_story18_2a = scene_story18_2a

function scene_story18_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story18_2a.actions.start_story18_2a(_root, args)
	return sequential({
		act({
			action = "activateNode",
...
local function story18_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story18_2a",
					scene = scene_story18_2a
				}
			end
		})
	})
