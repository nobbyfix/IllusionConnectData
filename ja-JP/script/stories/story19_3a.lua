...
function scene_story19_3a.actions.start_story19_3a(_root, args)
	return sequential({
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_laojia"),
			args = function (_ctx)
				return {
					isLoop = true
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "xiao_laojia"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_youlechang"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "xiao_youleyuan"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_youlechang"),
			args = function (_ctx)
				return {
					isLoop = true
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_duanmi"),
			args = function (_ctx)
				return {
					isLoop = true
				}
