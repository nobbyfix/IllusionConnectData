...
module("storysandbox.eventstory_wish_04")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_04 = {
	actions = {}
}
scenes.scene_eventstory_wish_04 = scene_eventstory_wish_04

function scene_eventstory_wish_04:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_1a(_root, args)
	return sequential({
		concurrent({
			act({
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_1b(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_1end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "moveTo",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_2a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_2b(_root, args)
	return sequential({
		concurrent({
			act({
				action = "play",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_2end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_3a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_3b(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_04.actions.start_eventstory_wish_04_3end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
local function eventstory_wish_04(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_04",
					scene = scene_eventstory_wish_04
				}
			end
		})
	})
...
stories.eventstory_wish_04 = eventstory_wish_04
