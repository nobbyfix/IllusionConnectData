...
module("storysandbox.eventstory_wish_02")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_02 = {
	actions = {}
}
scenes.scene_eventstory_wish_02 = scene_eventstory_wish_02

function scene_eventstory_wish_02:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_02.actions.start_eventstory_wish_02(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
function scene_eventstory_wish_02.actions.start_eventstory_wish_02_1a(_root, args)
	return sequential({
		concurrent({
			act({
...
function scene_eventstory_wish_02.actions.start_eventstory_wish_02_1b(_root, args)
	return sequential({
		concurrent({
			sequential({
				act({
...
function scene_eventstory_wish_02.actions.start_eventstory_wish_02_1end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "Mus_nengli"),
				args = function (_ctx)
					return {
						isLoop = true
					}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "zuoyankuang"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "youyankuang"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			act({
				action = "fadeIn",
				actor = __getnode__(_root, "zuoyan"),
				args = function (_ctx)
					return {
						duration = 0
					}
			...
			act({
				action = "fadeIn",
				actor = __getnode__(_root, "youyan"),
				args = function (_ctx)
					return {
						duration = 0
					}
...
local function eventstory_wish_02(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_02",
					scene = scene_eventstory_wish_02
				}
			end
		})
	})
...
stories.eventstory_wish_02 = eventstory_wish_02
