...
module("storysandbox.eventstory_easterday_04a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_easterday_04a = {
	actions = {}
}
scenes.scene_eventstory_easterday_04a = scene_eventstory_easterday_04a

function scene_eventstory_easterday_04a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_easterday_04a.actions.start_eventstory_easterday_04a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_easterday_04a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_easterday_04a",
					scene = scene_eventstory_easterday_04a
				}
			end
		})
	})
...
stories.eventstory_easterday_04a = eventstory_easterday_04a
