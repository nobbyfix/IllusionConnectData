...
module("storysandbox.eventstory_gohome_07a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_gohome_07a = {
	actions = {}
}
scenes.scene_eventstory_gohome_07a = scene_eventstory_gohome_07a

function scene_eventstory_gohome_07a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_gohome_07a.actions.start_eventstory_gohome_07a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
local function eventstory_gohome_07a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_gohome_07a",
					scene = scene_eventstory_gohome_07a
				}
			end
		})
	})
...
stories.eventstory_gohome_07a = eventstory_gohome_07a
