...
module("storysandbox.eventstory_siren_07a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_siren_07a = {
	actions = {}
}
scenes.scene_eventstory_siren_07a = scene_eventstory_siren_07a

function scene_eventstory_siren_07a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_siren_07a.actions.start_eventstory_siren_07a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		concurrent({
			act({
				...
				args = function (_ctx)
					return {
						content = {
							"eventstory_siren_07a_1",
							{
								"eventstory_siren_07a_2",
								"eventstory_siren_07a_3",
								"eventstory_siren_07a_4",
								"eventstory_siren_07a_5"
							}
						}
					}
				end
		...
		act({
			...
			args = function (_ctx)
				return {
					...
					heightSpace = 12,
					content = {
						"eventstory_siren_07a_6",
						"eventstory_siren_07a_7",
						"eventstory_siren_07a_8",
						"eventstory_siren_07a_9"
					},
					waitTimes = {
						5
					}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Se_Effect_Wave2"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		concurrent({
			act({
				action = "updateNode",
				actor = __getnode__(_root, "WEDe_speak1"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "dialog_speak_name_241",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					content = {
						"eventstory_siren_07a_35"
					},
					durations = {
						0.03
					}
...
local function eventstory_siren_07a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_siren_07a",
					scene = scene_eventstory_siren_07a
				}
			end
		})
	})
...
stories.eventstory_siren_07a = eventstory_siren_07a
