...
function scene_story20_1a.actions.start_story20_1a(_root, args)
	return sequential({
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "storyg20_dialog_speak_name_5",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "storyg20_dialog_speak_name_4",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "storyg20_dialog_speak_name_3",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "xiao_mengjing3"),
				args = function (_ctx)
					return {
						time = -1
					}
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "storyg20_dialog_speak_name_7",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "storyg20_dialog_speak_name_8",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "MLYTLSha/MLYTLSha_face_8.png",
					pathType = "STORY_FACE"
				}
			end
		}),
