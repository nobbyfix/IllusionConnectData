...
module("storysandbox.story21_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story21_3a = {
	actions = {}
}
scenes.scene_story21_3a = scene_story21_3a

function scene_story21_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				resType = 0,
				name = "bg_story_scence_12_3",
				pathType = "SCENE",
				type = "Image",
				image = "bg_story_scence_12_3.jpg",
				layoutMode = 1,
				zorder = 10,
				id = "bg_story_scence_12_3",
				scale = 1,
				anchorPoint = {
					x = 0.5,
					y = 0.5
			...
			{
				resType = 0,
				name = "bg_story_EXscene_0_2",
				pathType = "SCENE",
				type = "Image",
				image = "bg_story_EXscene_0_2.jpg",
				layoutMode = 1,
				zorder = 10,
				id = "bg_story_EXscene_0_2",
				scale = 1,
				anchorPoint = {
					x = 0.5,
					y = 0.5
...
function scene_story21_3a.actions.start_story21_3a(_root, args)
	return sequential({
		sleep({
			args = function (_ctx)
				return {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "StoryEnd21_dialog_speak_name_4",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "main_img_16"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "StoryEnd21_dialog_speak_name_8",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_story_scence_12_3"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "cg_zhuiluo"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "cg_guowang"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_story_EXscene_0_2"),
			args = function (_ctx)
				return {
					duration = 0
				}
...
local function story21_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story21_3a",
					scene = scene_story21_3a
				}
			end
		})
	})
