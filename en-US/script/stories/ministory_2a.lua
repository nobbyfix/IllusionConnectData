...
module("storysandbox.ministory_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_ministory_2a = {
	actions = {}
}
scenes.scene_ministory_2a = scene_ministory_2a

function scene_ministory_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_ministory_2a.actions.start_ministory_2a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "addPortrait",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "ministory_dialog_speak_name_1",
...
local function ministory_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_ministory_2a",
					scene = scene_ministory_2a
				}
			end
		})
	})
...
stories.ministory_2a = ministory_2a
