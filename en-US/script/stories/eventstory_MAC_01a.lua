...
module("storysandbox.eventstory_MAC_01a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_MAC_01a = {
	actions = {}
}
scenes.scene_eventstory_MAC_01a = scene_eventstory_MAC_01a

function scene_eventstory_MAC_01a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_MAC_01a.actions.start_eventstory_MAC_01a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_MAC_01a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_MAC_01a",
					scene = scene_eventstory_MAC_01a
				}
			end
		})
	})
...
stories.eventstory_MAC_01a = eventstory_MAC_01a
