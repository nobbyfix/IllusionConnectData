...
module("storysandbox.story18_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story18_3a = {
	actions = {}
}
scenes.scene_story18_3a = scene_story18_3a

function scene_story18_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story18_3a.actions.start_story18_3a(_root, args)
	return sequential({
		act({
			action = "activateNode",
...
local function story18_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story18_3a",
					scene = scene_story18_3a
				}
			end
		})
	})
