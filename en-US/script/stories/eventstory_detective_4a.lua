...
module("storysandbox.eventstory_detective_4a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_detective_4a = {
	actions = {}
}
scenes.scene_eventstory_detective_4a = scene_eventstory_detective_4a

function scene_eventstory_detective_4a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_detective_4a.actions.start_eventstory_detective_4a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "activateNode",
		...
		act({
			...
			args = function (_ctx)
				return {
					content = {
						"eventstory_detective_4a_35",
						"eventstory_detective_4a_36"
					},
					storyLove = {}
				}
			end
...
local function eventstory_detective_4a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_detective_4a",
					scene = scene_eventstory_detective_4a
				}
			end
		})
	})
...
stories.eventstory_detective_4a = eventstory_detective_4a
