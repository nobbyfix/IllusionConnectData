...
module("storysandbox.story13_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story13_2a = {
	actions = {}
}
scenes.scene_story13_2a = scene_story13_2a

function scene_story13_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story13_2a.actions.start_story13_2a(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "liqi_Hit1"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "liqi_Hit2"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "liqi_Hit3"),
			args = function (_ctx)
				return {
					time = -1
				}
...
local function story13_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story13_2a",
					scene = scene_story13_2a
				}
			end
		})
	})
