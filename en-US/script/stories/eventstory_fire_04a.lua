...
module("storysandbox.eventstory_fire_04a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_fire_04a = {
	actions = {}
}
scenes.scene_eventstory_fire_04a = scene_eventstory_fire_04a

function scene_eventstory_fire_04a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_fire_04a.actions.start_eventstory_fire_04a(_root, args)
	return sequential({
		sleep({
			args = function (_ctx)
				return {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "fire_dialog_speak_name_16",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "hqbfang/face_hqbfang_1.png",
					pathType = "STORY_FACE"
				}
			end
		}),
		...
		act({
			...
			args = function (_ctx)
				return {
					...
					center = 1,
					content = {
						"eventstory_fire_04a_36",
						"eventstory_fire_04a_37"
					},
					durations = {
						0.07,
						0.07
...
local function eventstory_fire_04a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_fire_04a",
					scene = scene_eventstory_fire_04a
				}
			end
		})
	})
...
stories.eventstory_fire_04a = eventstory_fire_04a
