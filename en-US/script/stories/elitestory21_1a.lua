...
module("storysandbox.elitestory21_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_elitestory21_1a = {
	actions = {}
}
scenes.scene_elitestory21_1a = scene_elitestory21_1a

function scene_elitestory21_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_elitestory21_1a.actions.start_elitestory21_1a(_root, args)
	return sequential({
		sleep({
			args = function (_ctx)
				return {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_30",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_31",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_32",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
...
local function elitestory21_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_elitestory21_1a",
					scene = scene_elitestory21_1a
				}
			end
		})
	})
...
stories.elitestory21_1a = elitestory21_1a
