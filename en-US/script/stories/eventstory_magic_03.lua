...
module("storysandbox.eventstory_magic_03")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_magic_03 = {
	actions = {}
}
scenes.scene_eventstory_magic_03 = scene_eventstory_magic_03

function scene_eventstory_magic_03:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_magic_03.actions.start_eventstory_magic_03(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
local function eventstory_magic_03(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_magic_03",
					scene = scene_eventstory_magic_03
				}
			end
		})
	})
...
stories.eventstory_magic_03 = eventstory_magic_03
