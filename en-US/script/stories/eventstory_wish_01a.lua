...
module("storysandbox.eventstory_wish_01a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_01a = {
	actions = {}
}
scenes.scene_eventstory_wish_01a = scene_eventstory_wish_01a

function scene_eventstory_wish_01a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_01a.actions.start_eventstory_wish_01a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
function scene_eventstory_wish_01a.actions.start_eventstory_wish_01_1a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_01a.actions.start_eventstory_wish_01_1b(_root, args)
	return sequential({
		concurrent({
			act({
				action = "speak",
...
function scene_eventstory_wish_01a.actions.start_eventstory_wish_01_1end(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function eventstory_wish_01a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_01a",
					scene = scene_eventstory_wish_01a
				}
			end
		})
	})
...
stories.eventstory_wish_01a = eventstory_wish_01a
