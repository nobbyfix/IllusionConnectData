...
module("storysandbox.elitestory16_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_elitestory16_1a = {
	actions = {}
}
scenes.scene_elitestory16_1a = scene_elitestory16_1a

function scene_elitestory16_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_elitestory16_1a.actions.start_elitestory16_1a(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_6",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_7",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_8",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NewElite_dialog_speak_name_9",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
...
local function elitestory16_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_elitestory16_1a",
					scene = scene_elitestory16_1a
				}
			end
		})
	})
...
stories.elitestory16_1a = elitestory16_1a
