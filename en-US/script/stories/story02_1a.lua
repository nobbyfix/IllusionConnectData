...
module("storysandbox.story02_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story02_1a = {
	actions = {}
}
scenes.scene_story02_1a = scene_story02_1a

function scene_story02_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Voice_Story_CLMan_02",
				fileName = "Voice_Story_CLMan_02",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_01",
				fileName = "Voice_Story_ZTXChang_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_FTLEShi_01",
				fileName = "Voice_Story_FTLEShi_01",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_MLYTLSha_01",
				fileName = "Voice_Story_MLYTLSha_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_03",
				fileName = "Voice_Story_ZTXChang_03",
				type = "Sound"
			},
			{
				id = "Voice_Story_BLTu_03",
				fileName = "Voice_Story_BLTu_03",
				type = "Sound"
			},
			{
				id = "Voice_Story_BLTu_04",
				fileName = "Voice_Story_BLTu_04",
				type = "Sound"
			},
			{
				id = "Voice_Story_FTLEShi_02",
				fileName = "Voice_Story_FTLEShi_02",
				type = "Sound"
			}
		},
...
function scene_story02_1a.actions.start_story02_1a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_CLMan_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FTLEShi_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story02_1a.actions.start_story02_1b(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "CLMan_face"),
...
function scene_story02_1a.actions.start_story02_1c(_root, args)
	return sequential({
		act({
			action = "fadeOut",
			actor = __getnode__(_root, "CLMan_speak"),
...
function scene_story02_1a.actions.start_story02_1d(_root, args)
	return sequential({
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "FTLEShi_speak"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_MLYTLSha_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story02_1a.actions.start_story02_1e(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "MLYTLSha_face"),
...
function scene_story02_1a.actions.start_story02_1f(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "MLYTLSha_face"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_03")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story02_1a.actions.start_story02_1f_1(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story02_1a.actions.start_story02_1f_2(_root, args)
	return sequential({
		act({
			action = "changeTexture",
			actor = __getnode__(_root, "CLMan_face"),
...
function scene_story02_1a.actions.start_story02_1f_3(_root, args)
	return sequential({
		concurrent({
			act({
				action = "fadeOut",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_BLTu_03")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mail_Sound")
		}),
		act({
			action = "stop",
			actor = __getnode__(_root, "Mus_Story_Common_2")
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_BLTu_04")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FTLEShi_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story02_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story02_1a",
					scene = scene_story02_1a
				}
			end
		})
	})
