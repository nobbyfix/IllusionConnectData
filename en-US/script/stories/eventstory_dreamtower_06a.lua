...
module("storysandbox.eventstory_dreamtower_06a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_dreamtower_06a = {
	actions = {}
}
scenes.scene_eventstory_dreamtower_06a = scene_eventstory_dreamtower_06a

function scene_eventstory_dreamtower_06a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_dreamtower_06a.actions.start_eventstory_dreamtower_06a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_dreamtower_06a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_dreamtower_06a",
					scene = scene_eventstory_dreamtower_06a
				}
			end
		})
	})
...
stories.eventstory_dreamtower_06a = eventstory_dreamtower_06a
