...
function RecruitHeroPreviewMediator:glueFieldAndUi()
	...
	local tempNode = bindWidget(self, bgNode, PopupNormalTabWidget, {
		...
		title1 = getCurrentLanguage() ~= GameLanguageType.CN and "" or Strings:get("UITitle_EN_Zhaohuanyulan"),
		fontSize = getCurrentLanguage() ~= GameLanguageType.CN and 23 or nil
	})
end
