...
function PayOffSystem:payInit()
	...
	if channelID == "wanmeiGlobal_ios" or channelID == "wanmeiGlobal_android" or channelID == "wanmeiGlobal_android_amazon" or channelID == "wanmeiGlobal_android_samsunapp" or channelID == "wanmeiGlobal_android_huaweiappgallery" or channelID == "wanmeiGlobal_android_apt" then
		...
		for k, v in pairs(payTable) do
			...
			if hasId(sDKSource, channelID) then
				...
				elseif channelID == "wanmeiGlobal_android" or channelID == "wanmeiGlobal_android_amazon" or channelID == "wanmeiGlobal_android_samsunapp" or channelID == "wanmeiGlobal_android_huaweiappgallery" or channelID == "wanmeiGlobal_android_apt" then
