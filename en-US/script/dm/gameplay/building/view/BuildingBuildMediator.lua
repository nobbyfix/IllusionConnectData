...
function BuildingBuildMediator:setupView()
	...
	if self._showType == 1 then
		bindWidget(self, bgNode, PopupNormalTabWidget, {
			...
			title1 = getCurrentLanguage() ~= GameLanguageType.CN and "" or Strings:get("UITitle_EN_Zhuangshi")
		})
	...
	elseif self._showType == 2 then
		bindWidget(self, bgNode, PopupNormalTabWidget, {
			...
			title1 = getCurrentLanguage() ~= GameLanguageType.CN and "" or Strings:get("UITitle_EN_Cangku")
		})
