...
function ActivityBlockChapterMediator:initWidget()
	...
	local rewardtext1 = self:getView():getChildByFullName("main.actionNode.btn_stage.Text1")
	local rewardtext3 = self:getView():getChildByFullName("main.actionNode.btn_stage.Text3")
	local Text_En = self:getView():getChildByFullName("main.actionNode.btn_stage.Text_En")
	...
	if getCurrentLanguage() ~= GameLanguageType.CN then
		...
		rewardtext1:setFontSize(26)
		emBattleText29:setFontSize(26)
		emBattleText2:setFontSize(26)
