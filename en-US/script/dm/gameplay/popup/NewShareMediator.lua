NewShareMediator = class("NewShareMediator", DmPopupViewMediator, _M)

NewShareMediator:has("_developSystem", {
	is = "r"
...
function NewShareMediator:initialize()
	super.initialize(self)
end

function NewShareMediator:dispose()
...
function NewShareMediator:onRegister()
...
function NewShareMediator:enterWithData(data)
	data = data or {}
...
function NewShareMediator:addShare()
	local data = {
	...
	self._shareNode = DmGame:getInstance()._injector:getInstance(ShareSystem):addShare(data, true)

	self:close()
end

function NewShareMediator:showResult(data)
...
function NewShareMediator:showRarityUpEffect(parent, heroId)
...
function NewShareMediator:checkIsShowSkill(hero)
	local tipData = {}
...
function NewShareMediator:setupClickEnvs()
