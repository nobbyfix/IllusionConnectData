...
function RTPKMainMediator:setSeasonRule()
	...
	local Text_18 = self._rulePanel:getChildByName("Text_18")
	local btn_rule = self._rulePanel:getChildByName("btn_rule")

	btn_rule:setPositionX(Text_18:getPositionX() + Text_18:getContentSize().width + 20)
