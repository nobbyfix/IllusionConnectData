CurrencyIdKind = {
	kActivitySummerRe1Power = "IR_SummerStamina_Re",
	kSurface = "IR_Surface",
	kActivityHolidayPower = "IR_HolidayStamina",
	kActivityHalloween2ndPower = "IR_Halloween_2nd_Stamina",
	kPve = "IR_Pve",
	kActivityFireWorksPower = "IR_FireWorksStamina",
	kActivityStoryBook2ndPower = "IR_StoryBook_2nd_Stamina",
	kClub = "IR_Club",
	kActivityReZeroRePower = "IR_ReZeroStamina_Re",
	...
	kActivityMusicRePower = "IR_MusicFestivalStamina_Re",
	...
	kCrystal = "IR_Crystal",
	kActivityBakingRePower = "IR_BakingStamina_Re",
	kActivitySilentNightPower = "IR_SilentNightStamina",
	kAcitvitySnowPower = "IR_SnowflakeStamina",
	kTrial = "IR_Tower",
	kActivitySamuraiRePower = "IR_SamuraiStamina_Re",
	kActivityFire2ndPower = "IR_Fire_2nd_Stamina",
	kEquip13 = "IR_Equip13",
	kActivityStoryBookPower = "IR_StoryBookStamina",
	kEquip14 = "IR_Equip14",
	kDiamondDrawItem = "IM_DiamondDraw",
	kActivityMagicRePower = "IR_MagicStamina_Re",
	kActivityTerrorPower = "IR_TerrorStamina",
	kActivitySilentNight2ndPower = "IR_SilentNight_2nd_Stamina",
	kActivityReZeroPower = "IR_ReZeroStamina",
	kActivityFireworksRePower = "IR_FireworksStamina_Re",
	kActivityDuskPower = "IR_DuskStamina",
	kActivityDuskRePower = "IR_DuskStamina_Re",
	kActivityKnight2ndPower = "IR_Knight_2nd_Stamina",
	...
	kActivityDeepSeaRePower = "IR_DeepSeaStamina_Re",
	kStageArenaPower = "IR_StageArena",
	kAcitvityZuoHeRePower = "IR_ZuoHeAcitvityStamina_Re",
	kAcitvityWxhPower = "IR_WuXiuHuiAcitvityStamina",
	kActivityDramaRePower = "IR_DramaStamina_Re",
	kDiamond = "IR_Diamond",
	kGoldDrawItem = "IM_GoldDraw",
	kActivityPurewhite2ndPower = "IR_Purewhite_2nd_Stamina",
	...
	kTECH = "IR_TECH",
	kActivitySpringRePower = "IR_SpringStamina_Re",
	kDiamondDrawEX_SAGA = "IM_DiamondDrawEX_SAGA",
	...
	kActivityEasterPower = "IR_EasterStamina",
...
ActivityType_UI = {
	...
	KActivityEaster = "ACTIVITYEaster",
	kActivityPass = "BattlePass",
...
UserDefaultKey = {
	...
	kStoreCommunity = "kStoreCommunity",
	...
	kLocalRegionServer = "kLocalRegionServer",
...
PowerConfigMap = {
	...
	[CurrencyIdKind.kAcitvityZuoHeRePower] = {
		all = "Act_ZuoHe_Power_RecAll",
		perMin = "Act_ZuoHe_Power_RecPerMin",
		next = "Act_ZuoHe_Power_RecNext",
		func = "getPowerByCurrencyId",
	...
	[CurrencyIdKind.kAcitvityHalloweenRePower] = {
		all = "Act_Halloween_Power_RecAll",
		perMin = "Act_Halloween_Power_RecPerMin",
		next = "Act_Halloween_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityHalloweenStamina_Reset_Re",
		tips = "ACTIVITY_Halloween_NOT_ENOUGH_2",
		tableName = "Reset"
	},
	...
	[CurrencyIdKind.kActivityDeepSeaRePower] = {
		all = "Act_DeepSea_Power_RecAll",
		perMin = "Act_DeepSea_Power_RecPerMin",
		next = "Act_DeepSea_Power_RecNext",
		func = "getPowerByCurrencyId",
	...
	[CurrencyIdKind.kActivityEasterPower] = {
		all = "Act_Easter_Power_RecAll",
		perMin = "Act_Easter_Power_RecPerMin",
		next = "Act_Easter_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityEasterStamina_Reset",
		tips = "ACTIVITY_Easter_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityMagicRePower] = {
		all = "Act_Magic_Power_RecAll",
		perMin = "Act_Magic_Power_RecPerMin",
		next = "Act_Magic_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityMagicStamina_Reset_Re",
		tips = "ACTIVITY_Magic_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivitySummerRe1Power] = {
		all = "Act_SummerRe_Power_RecAll",
		perMin = "Act_SummerRe_Power_RecPerMin",
		next = "Act_SummerRe_Power_RecNext",
		func = "getPowerByCurrencyId",
	...
	[CurrencyIdKind.kActivityReZeroRePower] = {
		...
		next = "Act_ReZero_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityReZeroStamina_Reset_Re",
		tips = "ACTIVITY_ReZero_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityMusicRePower] = {
		all = "Act_MusicFestival_Power_RecAll",
		perMin = "Act_MusicFestival_Power_RecPerMin",
		next = "Act_MusicFestival_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityMusicFestivalStamina_Reset_Re",
		tips = "ACTIVITY_MusicFestival_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityFireworksRePower] = {
		all = "Act_FireWorks_Power_RecAll",
		perMin = "Act_FireWorks_Power_RecPerMin",
		next = "Act_FireWorks_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityFireworksStamina_Reset_Re",
		tips = "ACTIVITY_FireWorks_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivitySamuraiRePower] = {
		all = "Act_Samurai_Power_RecAll",
		perMin = "Act_Samurai_Power_RecPerMin",
		next = "Act_Samurai_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvitySamuraiStamina_Reset_Re",
		tips = "ACTIVITY_Samurai_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityBakingRePower] = {
		all = "Act_Baking_Power_RecAll",
		perMin = "Act_Baking_Power_RecPerMin",
		next = "Act_Baking_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityBakingStamina_Reset_Re",
		tips = "ACTIVITY_Baking_ENERGY_NOT_ENOUGH",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivitySpringRePower] = {
		all = "Act_Spring_Power_RecAll",
		perMin = "Act_Spring_Power_RecPerMin",
		next = "Act_Spring_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvitySpringStamina_Reset_Re",
		tips = "ACTIVITY_Spring_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityKnight2ndPower] = {
		all = "Act_Knight_Power_RecAll",
		perMin = "Act_Knight_Power_RecPerMin",
		next = "Act_Knight_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityKnight_2nd_Stamina_Reset",
		tips = "ACTIVITY_Knight_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityPurewhite2ndPower] = {
		all = "Act_PureWhite_Power_RecAll",
		perMin = "Act_PureWhite_Power_RecPerMin",
		next = "Act_PureWhite_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityPurewhite_2nd_Stamina_Reset",
		tips = "ACTIVITY_PureWhite_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityFire2ndPower] = {
		all = "Act_Fire_Power_RecAll",
		perMin = "Act_Fire_Power_RecPerMin",
		next = "Act_Fire_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityFire_2nd_Stamina_Reset",
		tips = "ACTIVITY_Fire_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityStoryBook2ndPower] = {
		all = "Act_StoryBook_Power_RecAll",
		perMin = "Act_StoryBook_Power_RecPerMin",
		next = "Act_StoryBook_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityStoryBook_2nd_Stamina_Reset",
		tips = "ACTIVITY_StoryBook_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivitySilentNight2ndPower] = {
		all = "Act_SilentNight_Power_RecAll",
		perMin = "Act_SilentNight_Power_RecPerMin",
		next = "Act_SilentNight_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvitySilentNight_2nd_Stamina_Reset",
		tips = "ACTIVITY_SilentNight_NOT_ENOUGH_1",
		tableName = "Reset"
	},
	[CurrencyIdKind.kActivityHalloween2ndPower] = {
		all = "Act_Halloween_Power_RecAll",
		perMin = "Act_Halloween_Power_RecPerMin",
		next = "Act_Halloween_Power_RecNext",
		func = "getPowerByCurrencyId",
		configId = "AcitvityHalloween_2nd_Stamina_Reset",
		tips = "ACTIVITY_Halloween_NOT_ENOUGH_2",
		tableName = "Reset"
	},
	TEST = {
