...
all.EquipSkill_Weapon_15133_1 = {
	__new__ = function (prototype, externs, global)
		...
		this.gain = externs.gain

		assert(this.gain ~= nil, "External variable `gain` is not provided.")
...
all.EquipSkill_Weapon_15132_2 = {
	__new__ = function (prototype, externs, global)
		...
		this.MaximumLifeBonus = externs.MaximumLifeBonus

		assert(this.MaximumLifeBonus ~= nil, "External variable `MaximumLifeBonus` is not provided.")
...
all.EquipSkill_Weapon_15129_2 = {
	__new__ = function (prototype, externs, global)
		...
		this.MHDmgFactor = externs.MHDmgFactor

		if this.MHDmgFactor == nil then
			this.MHDmgFactor = 0.1
		end
...
all.EquipSkill_Weapon_15136_1 = {
	...
	passive2 = function (_env, externs)
		...
		exec["@time"]({
			...
			local this = _env.this
			local global = _env.global
			local count = global.GetEnergy(_env, global.GetOwner(_env, _env.ACTOR))
...
all.EquipSkill_Tops_15114_2 = {
	__new__ = function (prototype, externs, global)
		...
		this.Shield_volume = externs.Shield_volume

		assert(this.Shield_volume ~= nil, "External variable `Shield_volume` is not provided.")
...
all.EquipSkill_Tops_15113_1 = {
	__new__ = function (prototype, externs, global)
		...
		this.reply = externs.reply

		assert(this.reply ~= nil, "External variable `reply` is not provided.")
...
all.EquipSkill_Tops_15117_2 = {
	__new__ = function (prototype, externs, global)
		...
		if this.UnBlockRateFactor == nil then
			this.UnBlockRateFactor = 0.2
		end
...
all.EquipSkill_Shoes_15118_3 = {
	__new__ = function (prototype, externs, global)
		...
		this.spend = externs.spend

		if this.spend == nil then
			this.spend = global.spend or 15
		end
...
all.EquipSkill_Boots_15108_2_Passive = {
	__new__ = function (prototype, externs, global)
		...
		this.cid = externs.cid

		assert(this.cid ~= nil, "External variable `cid` is not provided.")
...
all.EquipSkill_Shoes_15117_2 = {
	__new__ = function (prototype, externs, global)
		...
		this.recoveryAmount = externs.recoveryAmount

		assert(this.recoveryAmount ~= nil, "External variable `recoveryAmount` is not provided.")
...
all.EquipSkill_Shoes_15122_1 = {
	__new__ = function (prototype, externs, global)
		...
		this.DeCriRateFactor = externs.DeCriRateFactor

		if this.DeCriRateFactor == nil then
			this.DeCriRateFactor = 0.15
		end

		this.MaxHpRateFactor = externs.MaxHpRateFactor

		if this.MaxHpRateFactor == nil then
			this.MaxHpRateFactor = 0.45
		end

		this.AOEDeRateFactor = externs.AOEDeRateFactor

		if this.AOEDeRateFactor == nil then
			this.AOEDeRateFactor = 0.45
		end
...
all.EquipSkill_Shoes_15121_3 = {
	__new__ = function (prototype, externs, global)
		...
		this.PetsRPFactor = externs.PetsRPFactor

		if this.PetsRPFactor == nil then
			this.PetsRPFactor = 500
		end

		this.SummonRPFactor = externs.SummonRPFactor

		if this.SummonRPFactor == nil then
			this.SummonRPFactor = 250
		end
	...
	passive2 = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.INSTATUS(_env, "Only")(_env, _env.ACTOR) and not global.MASTER(_env, _env.ACTOR) and global.GetSide(_env, _env.unit) == global.GetSide(_env, _env.ACTOR) and global.PETS + global.SUMMONS(_env, _env.unit) and global.SpecialPropGetter(_env, "EquipSkill_Shoes_15121_3_die")(_env, global.FriendField(_env)) < 4 then
				...
				if global.SUMMONS(_env, _env.unit) then
					RPFactor = this.SummonRPFactor
				end

				global.ApplyRPRecovery(_env, _env.ACTOR, RPFactor)
	...
	passive3 = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.FriendMaster(_env) and global.MASTER(_env, _env.ACTOR) and not global.MARKED(_env, "DAGUN")(_env, _env.ACTOR) and not global.MARKED(_env, "SP_DDing")(_env, _env.ACTOR) or global.FriendMaster(_env) == nil then
				if global.SelectBuffCount(_env, _env.ACTOR, global.BUFF_MARKED(_env, "EquipSkill_Shoes_15121_3_flag")) <= 0 then
					local Flags1 = {
						"ASSASSIN",
						"WARRIOR",
						"MAGE",
...
all.EquipSkill_Shoes_15124_1 = {
	__new__ = function (prototype, externs, global)
		...
		if this.SingleRateFactor == nil then
			this.SingleRateFactor = 0.05
		end

		this.AOERateFactor = externs.AOERateFactor

		if this.AOERateFactor == nil then
			this.AOERateFactor = 0.05
		end
...
all.EquipSkill_Decoration_15114_2 = {
	__new__ = function (prototype, externs, global)
		...
		this.anger = externs.anger

		assert(this.anger ~= nil, "External variable `anger` is not provided.")
...
all.EquipSkill_Accesory_15112_3 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
		...
		this.MHpToAtkFactor = externs.MHpToAtkFactor

		if this.MHpToAtkFactor == nil then
			this.MHpToAtkFactor = 0.025
		end
...
all.EquipSkill_Decoration_15113_1 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
		...
		this.treatmentRate = externs.treatmentRate

		assert(this.treatmentRate ~= nil, "External variable `treatmentRate` is not provided.")
...
all.EquipSkill_Accesory_15117_2 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.EquipSkill_Accesory_15117_2_field = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
	...
	passive = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.SelectHeroPassiveCount(_env, _env.unit, "EquipSkill_Decoration_15117_2") > 0 and global.GetCost(_env, _env.unit) >= 14 and global.GetSide(_env, _env.unit) == global.GetSide(_env, _env.ACTOR) and global.SpecialPropGetter(_env, "EquipSkill_Accesory_15117_2_energy" .. global.GetUnitCid(_env, _env.unit))(_env, global.FriendField(_env)) < 2 then
				...
				local Energy = global.floor(_env, cost * this.EnergyFactor)
...
all.EquipSkill_Decoration_15116_1 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.EquipSkill_Decoration_15118_3 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.EquipSkill_Decoration_15118_3_field = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.EquipSkill_Decoration_15119_2 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
...
all.EquipSkill_Decoration_15120_1 = {
	__new__ = function (prototype, externs, global)
		local __function = global.__skill_function__
		local __action = global.__skill_action__
		local this = global.__skill({
