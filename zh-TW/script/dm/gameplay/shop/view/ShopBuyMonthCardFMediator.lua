...
function ShopBuyMonthCardFMediator:refreshIcon()
	...
	local iconPath = self._data._icon
	local icon = nil

	if buyIconPath then
		icon = ccui.ImageView:create(buyIconPath)
	else
