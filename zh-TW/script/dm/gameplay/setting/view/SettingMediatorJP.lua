SettingMediatorJP = class("SettingMediatorJP", DmPopupViewMediator, _M)

SettingMediatorJP:has("_developSystem", {
	is = "r"
}):injectWith("DevelopSystem")
SettingMediatorJP:has("_settingSystem", {
	is = "r"
}):injectWith("SettingSystem")
SettingMediatorJP:has("_gameServer", {
	is = "r"
}):injectWith("GameServerAgent")
SettingMediatorJP:has("_rechargeAndVipModel", {
	is = "r"
}):injectWith("RechargeAndVipModel")
SettingMediatorJP:has("_gameServerAgent", {
	is = "r"
}):injectWith("GameServerAgent")
SettingMediatorJP:has("_rechargeAndVipSystem", {
	is = "r"
}):injectWith("RechargeAndVipSystem")
SettingMediatorJP:has("_systemKeeper", {
	is = "rw"
...
function SettingMediatorJP:bindAccountCb()
end

function SettingMediatorJP:deleteAccountSuccess()
...
function SettingMediatorJP:initialize()
	super.initialize(self)
end

function SettingMediatorJP:dispose()
...
function SettingMediatorJP:onRegister()
...
function SettingMediatorJP:loadPlayerInfo()
...
function SettingMediatorJP:mapEventListeners()
...
function SettingMediatorJP:enterWithData(data)
...
function SettingMediatorJP:createTabController()
	local config = {
...
function SettingMediatorJP:showPlayerInfoView()
...
function SettingMediatorJP:showSettingView()
...
function SettingMediatorJP:setGameVersion()
...
function SettingMediatorJP:changePlayerSlogan()
...
function SettingMediatorJP:enterDownlandView(type)
...
function SettingMediatorJP:refreshRightList()
...
function SettingMediatorJP:updateBtnView(viewName)
	local buttons = {}
...
function SettingMediatorJP:setupGameSetView()
...
function SettingMediatorJP:initGameSetValue()
...
function SettingMediatorJP:initAdjustSlider()
...
function SettingMediatorJP:initMusicSlider()
...
function SettingMediatorJP:initSoundSlider()
...
function SettingMediatorJP:initRoleSoundSlider()
...
function SettingMediatorJP:onClickClose(sender, eventType)
	if eventType == ccui.TouchEventType.ended then
		self:close()
	end
end

function SettingMediatorJP:onClickTab(name, tag)
...
function SettingMediatorJP:onClickCustomerService()
...
function SettingMediatorJP:onClickTermsBtn()
...
function SettingMediatorJP:onClickPrivacyBtn()
...
function SettingMediatorJP:onClickBindAccount()
...
function SettingMediatorJP:onClickDeleteAccount()
	SDKHelper:deleteAccount()
end

function SettingMediatorJP:onClickReLoginBtn()
	local data = {
...
function SettingMediatorJP:onClickInheritanceCodeBtn()
...
function SettingMediatorJP:onClickTestBtn(sender, type)
...
function SettingMediatorJP:onClickEffectBtn()
	local isOff = self._settingModel:isTouchEffectOff()

	self._settingSystem:setTouchEffectOff(not isOff)
end

function SettingMediatorJP:onClickFPSBtn(sender)
...
function SettingMediatorJP:onClickChangeName(sender, eventType)
	if eventType == ccui.TouchEventType.ended then
...
function SettingMediatorJP:onClickChangeSlogan(sender, eventType)
	if eventType == ccui.TouchEventType.ended then
		self._sloganEditBox:setText("")
...
function SettingMediatorJP:onClickBugFeedBack(sender, eventType)
end

function SettingMediatorJP:onClickGameAnnounce(sender, eventType)
...
function SettingMediatorJP:onClickExit(sender, eventType)
	if eventType == ccui.TouchEventType.ended then
...
function SettingMediatorJP:onClickQuestionBtn(sender, eventType)
...
function SettingMediatorJP:onClickAccountCenterBtn(sender, eventType)
	if eventType == ccui.TouchEventType.ended and SDKHelper and SDKHelper:isEnableSdk() then
		SDKHelper:userCenterByPwrdView()
	end
end

function SettingMediatorJP:onClickChangeHeadImg(sender, eventType)
	if eventType == ccui.TouchEventType.ended then
...
function SettingMediatorJP:onClickCheckInBtn()
	local monthSignInSystem = self:getInjector():getInstance(MonthSignInSystem)

	monthSignInSystem:tryEnter()
end

function SettingMediatorJP:onClickBindPhoneBtn()
	if SDKHelper:isEnableSdk() then
		SDKHelper:showBindPhone()
	end
end

function SettingMediatorJP:onClickSpinePortraitBtn()
	self._settingSystem:downloadPortrait()
end

function SettingMediatorJP:onClickSoundCVBtn()
	self._settingSystem:downloadSoundCV()
end

function SettingMediatorJP:getDownloadReward(event)
...
function SettingMediatorJP:commitPlayerInfo()
	local playerInfo = {
...
function SettingMediatorJP:onClickSetSex()
...
function SettingMediatorJP:onClickSetBirthDay()
...
function SettingMediatorJP:onClickSetArea()
...
function SettingMediatorJP:onClickSetTags()
...
function SettingMediatorJP:onClickCopyPlayerID()
	local player = self._developSystem:getPlayer()
	local idStr = string.split(player:getRid(), "_")
...
function SettingMediatorJP:onClickCode()
...
function SettingMediatorJP:onClickBuyMonthCard()
...
function SettingMediatorJP:parseTimeStr(timeStr)
	local _tab = {}
	local _str = nil
...
function SettingMediatorJP:isBindPhoneBtnShow()
	local bindState = SDKHelper:readCacheValue("loginType")

	return SDKHelper:isEnableSdk() and LOGIN_TYPE_GUEST == bindState
end

function SettingMediatorJP:isGameAnnounceShow()
	return true
end

function SettingMediatorJP:isAccountCenterBtnShow()
	return false
end

function SettingMediatorJP:isQuestionBtnShow()
	if SDKHelper and SDKHelper:isEnableSdk() then
		return false
	end
...
function SettingMediatorJP:isBugFeedbackShow()
...
function SettingMediatorJP:isCheckInBtnShow()
	return CommonUtils.GetSwitch("fn_check_in")
end

function SettingMediatorJP:isWelfareCodeBtnShow()
	return GameConfigs.showAllSettingBtn or CommonUtils.GetSwitch("hideWelfareCodeBtn")
end

function SettingMediatorJP:isSoundDomShow()
...
function SettingMediatorJP:isResourceDomShow()
	if not self._settingSystem:hasPackage() then
		return false
	end
...
function SettingMediatorJP:isTermsBtnShow()
	return (SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn) and CommonUtils.GetSwitch("fn_setting_url")
end

function SettingMediatorJP:isPrivacyBtnShow()
	return (SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn) and CommonUtils.GetSwitch("fn_setting_url")
end

function SettingMediatorJP:isReLoginBtnShow()
	return SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn
end

function SettingMediatorJP:isBindAccountBtnShow()
	return SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn
end

function SettingMediatorJP:isDeleteAccountBtnShow()
	return SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn
end

function SettingMediatorJP:isCustomerServiceBtnShow()
	return SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn
end

function SettingMediatorJP:isInheritanceCodeBtnShow()
	return (SDKHelper and SDKHelper:isEnableSdk() or GameConfigs.showAllSettingBtn) and CommonUtils.GetSwitch("fn_inheritanceCode")
end

function SettingMediatorJP:isTestBtnShow()
