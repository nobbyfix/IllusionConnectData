CurrencyIdKind = {
	...
	kActivityRiddleRePower = "IR_RiddleStamina_Re",
...
UserDefaultKey = {
	...
	KAttFriendlyPage_next_day_login = "attFriendlyPage_next_day_login",
	...
	KAttFriendlyPage_created_role = "attFriendlyPage_created_role",
...
PowerConfigMap = {
	...
	[CurrencyIdKind.kActivityRiddleRePower] = {
		all = "Act_Riddle_Power_RecAll",
		perMin = "Act_Riddle_Power_RecPerMin",
		next = "Act_Riddle_Power_RecNext",
		func = "getPowerByCurrencyId",
