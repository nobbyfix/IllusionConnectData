...
require(__PACKAGE__ .. "effects.ShieldRatioEffect")
require(__PACKAGE__ .. "effects.HPRecoverRatioEffect")
require(__PACKAGE__ .. "effects.ImmuneTrapBuffEffect")
require(__PACKAGE__ .. "effects.OfflineEffect")
