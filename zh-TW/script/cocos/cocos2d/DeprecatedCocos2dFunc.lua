...
function TextureCacheDeprecated:destroyInstance()
...
function TextureCacheDeprecated:dumpCachedTextureInfo()
...
function CCTextureCacheDeprecated:addUIImage(image, key)
...
local CCAnimationDeprecated = {
	addSpriteFrameWithFileName = function (self, ...)
...
function CCAnimationCacheDeprecated:addAnimationsWithFile(...)
...
function CCAnimationCacheDeprecated:animationByName(...)
...
function CCAnimationCacheDeprecated:removeAnimationByName()
...
function CCMenuDeprecated:setHandlerPriority()
...
function CCNodeDeprecated:numberOfRunningActions()
...
function CCNodeDeprecated:removeFromParentAndCleanup(...)
...
local CCProgressTimerDeprecated = {
	setReverseProgress = function (self, ...)
...
local CCSpriteFrameCacheDeprecated = {
	spriteFrameByName = function (self, szName)
...
function CCSpriteFrameCacheDeprecated:addSpriteFramesWithFile(...)
...
function CCSpriteFrameCacheDeprecated:getSpriteFrameByName(...)
...
local function ccc4FFromccc3B(color3B)
	...
	return cc.c4f(color3B.r / 255, color3B.g / 255, color3B.b / 255, 1)
end
...
local function ccc4FFromccc4B(color4B)
	...
	return cc.c4f(color4B.r / 255, color4B.g / 255, color4B.b / 255, color4B.a / 255)
end
...
local function ccc4BFromccc4F(color4F)
	...
	return Color4B(color4F.r * 255, color4F.g * 255, color4F.b * 255, color4B.a * 255)
end
...
function CCGrid3DActionDeprecated:originalVertex(pt)
...
function CCTiledGrid3DActionDeprecated:originalTile(pt)
...
function CCTexture2DDeprecated:bitsPerPixelForFormat()
...
function CCTexture2DDeprecated:bitsPerPixelForFormat(pixelFormat)
	deprecatedTip("Texture2D:bitsPerPixelForFormat", "Texture2D:getBitsPerPixelForFormat")
...
function CCTexture2DDeprecated:defaultAlphaPixelFormat()
...
local CCTimerDeprecated = {
	timerWithScriptHandler = function (handler, seconds)
...
function CCTimerDeprecated:numberOfRunningActionsInTarget(target)
...
function CCMenuItemFontDeprecated:fontSizeObj()
...
function CCMenuItemFontDeprecated:fontNameObj()
...
local CCTMXLayerDeprecated = {
	tileAt = function (self, tileCoordinate)
...
function CCTMXLayerDeprecated:tileGIDAt(tileCoordinate)
...
function CCTMXLayerDeprecated:positionAt(tileCoordinate)
...
function CCTMXLayerDeprecated:propertyNamed(propertyName)
...
local CCTMXTiledMapDeprecated = {
	layerNamed = function (self, layerName)
...
function CCTMXTiledMapDeprecated:propertyNamed(propertyName)
...
function CCTMXTiledMapDeprecated:propertiesForGID(GID)
...
function CCTMXTiledMapDeprecated:objectGroupNamed(groupName)
...
local CCTMXMapInfoDeprecated = {
	getStoringCharacters = function (self)
...
local CCTMXObjectGroupDeprecated = {
	propertyNamed = function (self, propertyName)
...
function CCTMXObjectGroupDeprecated:objectNamed(objectName)
...
function CCSpriteDeprecated:setFlipY(flag)
...
function NodeDeprecated:getZOrder()
...
function NodeDeprecated:setVertexZ(vertexZ)
...
function NodeDeprecated:getVertexZ()
...
function NodeDeprecated:ignoreAnchorPointForPosition(ignore)
...
local GLProgram = {
	initWithVertexShaderByteArray = function (self, vShaderByteArray, fShaderByteArray)
...
function GLProgram:initWithVertexShaderFilename(vShaderByteArray, fShaderByteArray)
...
function GLProgram:addAttribute(attributeName, index)
