...
module("storysandbox.eventstory_wish_08a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_08a = {
	actions = {}
}
scenes.scene_eventstory_wish_08a = scene_eventstory_wish_08a

function scene_eventstory_wish_08a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_08a.actions.start_eventstory_wish_08a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "meng_left"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "meng_right"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "meng_up"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "meng_down"),
			args = function (_ctx)
				return {
					duration = 0
				}
...
local function eventstory_wish_08a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_08a",
					scene = scene_eventstory_wish_08a
				}
			end
		})
	})
...
stories.eventstory_wish_08a = eventstory_wish_08a
