...
module("storysandbox.eventstory_404_05a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_404_05a = {
	actions = {}
}
scenes.scene_eventstory_404_05a = scene_eventstory_404_05a

function scene_eventstory_404_05a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_404_05a.actions.start_eventstory_404_05a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
		...
		act({
			...
			args = function (_ctx)
				return {
					...
					center = 1,
					content = {
						"eventstory_404_05a_1",
						"eventstory_404_05a_2",
						"eventstory_404_05a_3",
						"eventstory_404_05a_4"
					},
					durations = {
						0.08,
						0.08,
		...
		concurrent({
			...
			act({
				action = "changeTexture",
				actor = __getnode__(_root, "HSeng_face"),
				args = function (_ctx)
					return {
						resType = 0,
...
local function eventstory_404_05a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_404_05a",
					scene = scene_eventstory_404_05a
				}
			end
		})
	})
...
stories.eventstory_404_05a = eventstory_404_05a
