...
module("storysandbox.eventstory_easterday_06a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_easterday_06a = {
	actions = {}
}
scenes.scene_eventstory_easterday_06a = scene_eventstory_easterday_06a

function scene_eventstory_easterday_06a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_easterday_06a.actions.start_eventstory_easterday_06a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "ALSi_TGWu/ALSi_TGWu_face_story_3.png",
					pathType = "STORY_FACE"
				}
			end
		}),
...
local function eventstory_easterday_06a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_easterday_06a",
					scene = scene_eventstory_easterday_06a
				}
			end
		})
	})
...
stories.eventstory_easterday_06a = eventstory_easterday_06a
