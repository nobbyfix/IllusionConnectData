...
module("storysandbox.ministory_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_ministory_1a = {
	actions = {}
}
scenes.scene_ministory_1a = scene_ministory_1a

function scene_ministory_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_ministory_1a.actions.start_ministory_1a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "addPortrait",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "ministory_dialog_speak_name_4",
...
local function ministory_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_ministory_1a",
					scene = scene_ministory_1a
				}
			end
		})
	})
...
stories.ministory_1a = ministory_1a
