...
module("storysandbox.eventstory_wish_02a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_02a = {
	actions = {}
}
scenes.scene_eventstory_wish_02a = scene_eventstory_wish_02a

function scene_eventstory_wish_02a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_02a.actions.start_eventstory_wish_02a(_root, args)
	return sequential({
		act({
			action = "fadeIn",
		...
		act({
			...
			args = function (_ctx)
				return {
					content = {
						"eventstory_wish_02_1",
						"eventstory_wish_02_2"
					},
					actionName = {
						"start_eventstory_wish_02_1a",
						"start_eventstory_wish_02_1b"
					}
				}
			end
		})
...
function scene_eventstory_wish_02a.actions.start_eventstory_wish_02_1a(_root, args)
	return sequential({
		concurrent({
			act({
		...
		enterSceneFollowAction({
			args = function (_ctx)
				return {
					name = "start_eventstory_wish_02_1end"
				}
			end
		})
	})
...
function scene_eventstory_wish_02a.actions.start_eventstory_wish_02_1b(_root, args)
	return sequential({
		concurrent({
			sequential({
				act({
			...
			act({
				...
				args = function (_ctx)
					return {
						name = "MyWish_dialog_speak_name_14",
						dialogImage = "silentnight_img_jqd.png",
						location = "left",
						pathType = "STORY_ROOT",
						speakings = {
...
function scene_eventstory_wish_02a.actions.start_eventstory_wish_02_1end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
		...
		concurrent({
			act({
				action = "play",
				actor = __getnode__(_root, "yin_mowanou"),
				args = function (_ctx)
					return {
						time = 1
					}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_shuaisui"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			act({
				action = "play",
				actor = __getnode__(_root, "yin_ninataopao"),
				args = function (_ctx)
					return {
						time = 1
					}
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "xiao_guangmang4"),
				args = function (_ctx)
					return {
						time = -1
					}
...
local function eventstory_wish_02a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_02a",
					scene = scene_eventstory_wish_02a
				}
			end
		})
	})
...
stories.eventstory_wish_02a = eventstory_wish_02a
