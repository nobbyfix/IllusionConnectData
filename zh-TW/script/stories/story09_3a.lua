...
function scene_story09_3a.actions.start_story09_3a(_root, args)
	return sequential({
		...
		act({
			action = "play",
			actor = __getnode__(_root, "anim_bennengsi"),
			args = function (_ctx)
				return {
					time = -1
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "baozha_EX"),
			args = function (_ctx)
				return {
					time = 1
				}
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "qiangpao_EXold"),
				args = function (_ctx)
					return {
						time = 1
					}
		...
		concurrent({
			act({
				action = "updateNode",
				actor = __getnode__(_root, "ZTXChang_nightingale_speak"),
				args = function (_ctx)
					return {
						opacity = 0
					}
