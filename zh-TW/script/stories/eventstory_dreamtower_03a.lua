...
module("storysandbox.eventstory_dreamtower_03a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_dreamtower_03a = {
	actions = {}
}
scenes.scene_eventstory_dreamtower_03a = scene_eventstory_dreamtower_03a

function scene_eventstory_dreamtower_03a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_dreamtower_03a.actions.start_eventstory_dreamtower_03a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_dreamtower_03a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_dreamtower_03a",
					scene = scene_eventstory_dreamtower_03a
				}
			end
		})
	})
...
stories.eventstory_dreamtower_03a = eventstory_dreamtower_03a
