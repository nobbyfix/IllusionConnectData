...
module("storysandbox.story19_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story19_2a = {
	actions = {}
}
scenes.scene_story19_2a = scene_story19_2a

function scene_story19_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story19_2a.actions.start_story19_2a(_root, args)
	return sequential({
		act({
			action = "activateNode",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_Anna_Song"),
			args = function (_ctx)
				return {
					isLoop = true
				}
...
local function story19_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story19_2a",
					scene = scene_story19_2a
				}
			end
		})
	})
