...
module("storysandbox.eventstory_MAC_09a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_MAC_09a = {
	actions = {}
}
scenes.scene_eventstory_MAC_09a = scene_eventstory_MAC_09a

function scene_eventstory_MAC_09a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_MAC_09a.actions.start_eventstory_MAC_09a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_MAC_09a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_MAC_09a",
					scene = scene_eventstory_MAC_09a
				}
			end
		})
	})
...
stories.eventstory_MAC_09a = eventstory_MAC_09a
