...
function scene_story18_1a.actions.start_story18_1a(_root, args)
	return sequential({
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_houtai"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_houtai"),
			args = function (_ctx)
				return {
					isLoop = true
				}
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_yemu"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_ancang"),
			args = function (_ctx)
				return {
					isLoop = true
				}
