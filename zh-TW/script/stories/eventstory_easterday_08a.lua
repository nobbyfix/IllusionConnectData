...
module("storysandbox.eventstory_easterday_08a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_easterday_08a = {
	actions = {}
}
scenes.scene_eventstory_easterday_08a = scene_eventstory_easterday_08a

function scene_eventstory_easterday_08a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_easterday_08a.actions.start_eventstory_easterday_08a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "BEr_WZi/BEr_WZi_face_2.png",
					pathType = "STORY_FACE"
				}
			end
		}),
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "dialog_speak_name_222",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					content = {
						"eventstory_easterday_08a_7"
					},
					durations = {
						0.03
					}
...
local function eventstory_easterday_08a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_easterday_08a",
					scene = scene_eventstory_easterday_08a
				}
			end
		})
	})
...
stories.eventstory_easterday_08a = eventstory_easterday_08a
