...
local right_text = [[
 개인정보처리방침
 
㈜창유닷컴코리아(이하 “회사”라 함)는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 및 「개인정보보호법」 「통신비밀보호법」, 「전기통신사업법」 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 “회원” 권익 보호에 최선을 다하고 있습니다.
 
...
② 회사는 회원가입 또는 외부 플랫폼 기반 서비스 이용 시 아래와 같은 필수 정보를 수집하고 있습니다.
- 창유 계정 이용 시 : 이메일 주소
- Google 계정 이용 시 : 회원 식별자 번호
- Facebook 계정 이용 시 : 암호화 된 회원 식별자 번호
- 애플 계정 이용 시 : 암호화 된 회원 식별자 번호
* 구글, 페이스북 ID 및 애플 ID로 게임을 이용하거나 공식 계정에 연동하는 경우 각 소셜 네트워크에서 제공하는 회원 식별자 번호 이외의 정보는 수집/저장하지 않습니다.
...
 
제 6조 수집한 개인정보의 처리 위탁
“회사”는 서비스 제공 및 이용자 편의 증진을 위하여 아래와 같이 개인정보를 처리 위탁하고 있으며, 관계 법령에 따라 위탁계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다. 회사의 개인정보 위탁처리 기관 및 위탁업무 내용은 아래와 같습니다.
1) ﻿㈜에드업
- 위탁 목적: 게임서비스운영, 고객상담 지원
