			...
			},
			{
				...
				injections = {
					...
					views = {
						...
						{
							res = "asset/ui/UnBindTips.csb",
							name = "UnBindView",
							mediator = "UnBindMediator"
						},
						{
							res = "asset/ui/GameProvision.csb",
							name = "GameProvisionView",
							mediator = "GameProvisionMediator"
						},
						{
			...
			},
			{
				...
				injections = {
					...
					views = {
						...
						{
							res = "asset/ui/refundDetail.csb",
							name = "RefundDetailView",
							mediator = "RefundDetailMediator"
						},
						{
