...
module("storysandbox.story07_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story07_2a = {
	actions = {}
}
scenes.scene_story07_2a = scene_story07_2a

function scene_story07_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Voice_Story_ZTXChang_20",
				fileName = "Voice_Story_ZTXChang_20",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_07",
				fileName = "Voice_Story_FEMSi_07",
				type = "Sound"
			},
			{
				id = "Voice_Story_HSheng_06",
				fileName = "Voice_Story_HSheng_06",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_08",
				fileName = "Voice_Story_FEMSi_08",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_09",
				fileName = "Voice_Story_FEMSi_09",
				type = "Sound"
			},
			{
				id = "Voice_Story_HSheng_07",
				fileName = "Voice_Story_HSheng_07",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_07",
			...
			{
				id = "Voice_Story_FEMSi_10",
				fileName = "Voice_Story_FEMSi_10",
				type = "Sound"
			},
			{
				id = "Voice_Story_HSheng_08",
				fileName = "Voice_Story_HSheng_08",
				type = "Sound"
			},
			{
				id = "Voice_Story_KTSJKe_04",
				fileName = "Voice_Story_KTSJKe_04",
				type = "Sound"
			},
			{
				id = "Voice_Story_HSheng_09",
				fileName = "Voice_Story_HSheng_09",
				type = "Sound"
			},
			{
				id = "Voice_Story_KTSJKe_05",
				fileName = "Voice_Story_KTSJKe_05",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_HSheng_10",
				fileName = "Voice_Story_HSheng_10",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_21",
				fileName = "Voice_Story_ZTXChang_21",
				type = "Sound"
			}
		},
...
function scene_story07_2a.actions.start_story07_2a(_root, args)
	return sequential({
		act({
			action = "play",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_20")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_07")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_HSheng_06")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_08")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_09")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_HSheng_07")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_10")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_HSheng_08")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		concurrent({
			act({
				action = "play",
				actor = __getnode__(_root, "Se_Skill_Laser_3")
			}),
			act({
				action = "rock",
				actor = __getnode__(_root, "KTSJKe_speak"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_KTSJKe_04")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_HSheng_09")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_KTSJKe_05")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_HSheng_10")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_21")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story07_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story07_2a",
					scene = scene_story07_2a
				}
			end
		})
	})
