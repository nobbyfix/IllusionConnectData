...
module("storysandbox.eventstory_easterday_02a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_easterday_02a = {
	actions = {}
}
scenes.scene_eventstory_easterday_02a = scene_eventstory_easterday_02a

function scene_eventstory_easterday_02a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_easterday_02a.actions.start_eventstory_easterday_02a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "dialog_speak_name_225",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					content = {
						"eventstory_easterday_02a_15"
					},
					durations = {
						0.03
					}
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "dialog_speak_name_220",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					content = {
						"eventstory_easterday_02a_29"
					},
					durations = {
						0.03
					}
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "ALSi_TGWu/ALSi_TGWu_face_story_5.png",
					pathType = "STORY_FACE"
				}
			end
		}),
...
local function eventstory_easterday_02a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_easterday_02a",
					scene = scene_eventstory_easterday_02a
				}
			end
		})
	})
...
stories.eventstory_easterday_02a = eventstory_easterday_02a
