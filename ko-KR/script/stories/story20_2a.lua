...
module("storysandbox.story20_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story20_2a = {
	actions = {}
}
scenes.scene_story20_2a = scene_story20_2a

function scene_story20_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story20_2a.actions.start_story20_2a(_root, args)
	return sequential({
		act({
			action = "activateNode",
...
local function story20_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story20_2a",
					scene = scene_story20_2a
				}
			end
		})
	})
