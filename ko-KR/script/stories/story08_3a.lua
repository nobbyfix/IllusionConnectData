...
module("storysandbox.story08_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story08_3a = {
	actions = {}
}
scenes.scene_story08_3a = scene_story08_3a

function scene_story08_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Voice_Story_ZTXChang_24",
				fileName = "Voice_Story_ZTXChang_24",
				type = "Sound"
			},
			{
				id = "Voice_Story_BLTu_08",
				fileName = "Voice_Story_BLTu_08",
				type = "Sound"
			},
			{
				id = "Voice_Story_FTLEShi_09",
				fileName = "Voice_Story_FTLEShi_09",
				type = "Sound"
			}
		},
...
function scene_story08_3a.actions.start_story08_3a(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_24")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_BLTu_08")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FTLEShi_09")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story08_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story08_3a",
					scene = scene_story08_3a
				}
			end
		})
	})
