...
module("storysandbox.story19_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story19_1a = {
	actions = {}
}
scenes.scene_story19_1a = scene_story19_1a

function scene_story19_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_story19_1a.actions.start_story19_1a(_root, args)
	return sequential({
		concurrent({
			act({
				action = "show",
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_fangda"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Mus_yanchanghui"),
			args = function (_ctx)
				return {
					isLoop = true
				}
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "NS16_19_dialog_speak_name_8",
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_laojia"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "BMonster_l"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "BMonster_m"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "BMonster_r"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		concurrent({
			...
			act({
				...
				args = function (_ctx)
					return {
						name = "NS16_19_dialog_speak_name_9",
						dialogImage = "jq_dialogue_bg_1.png",
						location = "left",
						pathType = "STORY_ROOT",
						speakings = {
		...
		act({
			action = "fadeIn",
			actor = __getnode__(_root, "bg_lixiangguo"),
			args = function (_ctx)
				return {
					duration = 0
				}
		...
		concurrent({
			act({
				action = "play",
				actor = __getnode__(_root, "Mus_lixiangguo"),
				args = function (_ctx)
					return {
						isLoop = true
					}
...
local function story19_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story19_1a",
					scene = scene_story19_1a
				}
			end
		})
	})
