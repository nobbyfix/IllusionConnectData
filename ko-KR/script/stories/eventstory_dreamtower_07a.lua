...
module("storysandbox.eventstory_dreamtower_07a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_dreamtower_07a = {
	actions = {}
}
scenes.scene_eventstory_dreamtower_07a = scene_eventstory_dreamtower_07a

function scene_eventstory_dreamtower_07a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_dreamtower_07a.actions.start_eventstory_dreamtower_07a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_dreamtower_07a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_dreamtower_07a",
					scene = scene_eventstory_dreamtower_07a
				}
			end
		})
	})
...
stories.eventstory_dreamtower_07a = eventstory_dreamtower_07a
