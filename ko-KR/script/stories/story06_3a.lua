...
module("storysandbox.story06_3a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story06_3a = {
	actions = {}
}
scenes.scene_story06_3a = scene_story06_3a

function scene_story06_3a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Voice_Story_MGNa_01",
				fileName = "Voice_Story_MGNa_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_MGNa_02",
				fileName = "Voice_Story_MGNa_02",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_04",
				fileName = "Voice_Story_FEMSi_04",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_17",
				fileName = "Voice_Story_ZTXChang_17",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_05",
				fileName = "Voice_Story_FEMSi_05",
				type = "Sound"
			},
			{
				id = "Voice_Story_FEMSi_06",
				fileName = "Voice_Story_FEMSi_06",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_18",
				fileName = "Voice_Story_ZTXChang_18",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_19",
				fileName = "Voice_Story_ZTXChang_19",
				type = "Sound"
			}
		},
...
function scene_story06_3a.actions.start_story06_3a(_root, args)
	return sequential({
		act({
			action = "show",
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_MGNa_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "mofa_In")
			})
		}),
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_MGNa_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_04")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "Block_Sound")
			}),
			rockScreen({
				args = function (_ctx)
					return {
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_17")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_05")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story06_3a.actions.start_story06_3e(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story06_3a.actions.start_story06_3f(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_story06_3a.actions.start_story06_3g(_root, args)
	return sequential({
		act({
			action = "show",
			actor = __getnode__(_root, "dialogueChoose"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_FEMSi_06")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_18")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_ZTXChang_19")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story06_3a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story06_3a",
					scene = scene_story06_3a
				}
			end
		})
	})
