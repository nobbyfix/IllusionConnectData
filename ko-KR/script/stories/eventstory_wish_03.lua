...
module("storysandbox.eventstory_wish_03")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_wish_03 = {
	actions = {}
}
scenes.scene_eventstory_wish_03 = scene_eventstory_wish_03

function scene_eventstory_wish_03:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_wish_03.actions.start_eventstory_wish_03(_root, args)
	return sequential({
		act({
			action = "fadeIn",
...
function scene_eventstory_wish_03.actions.start_eventstory_wish_03_1a(_root, args)
	return sequential({
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
function scene_eventstory_wish_03.actions.start_eventstory_wish_03_1b(_root, args)
	return sequential({
		concurrent({
			act({
				action = "changeTexture",
...
function scene_eventstory_wish_03.actions.start_eventstory_wish_03_1end(_root, args)
	return sequential({
		concurrent({
			act({
				action = "play",
...
local function eventstory_wish_03(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_wish_03",
					scene = scene_eventstory_wish_03
				}
			end
		})
	})
...
stories.eventstory_wish_03 = eventstory_wish_03
