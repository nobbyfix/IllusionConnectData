...
module("storysandbox.eventstory_dreamtower_08a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_eventstory_dreamtower_08a = {
	actions = {}
}
scenes.scene_eventstory_dreamtower_08a = scene_eventstory_dreamtower_08a

function scene_eventstory_dreamtower_08a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
...
function scene_eventstory_dreamtower_08a.actions.start_eventstory_dreamtower_08a(_root, args)
	return sequential({
		act({
			action = "stop",
...
local function eventstory_dreamtower_08a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_eventstory_dreamtower_08a",
					scene = scene_eventstory_dreamtower_08a
				}
			end
		})
	})
...
stories.eventstory_dreamtower_08a = eventstory_dreamtower_08a
