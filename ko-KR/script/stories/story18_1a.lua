...
module("storysandbox.story18_1a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story18_1a = {
	actions = {}
}
scenes.scene_story18_1a = scene_story18_1a

function scene_story18_1a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Se_Story_Chapter_18_19",
				fileName = "Se_Story_Chapter_18_19",
				type = "Sound"
			},
			{
...
function scene_story18_1a.actions.start_story18_1a(_root, args)
	return sequential({
		act({
			action = "stop",
		...
		concurrent({
			...
			act({
				action = "play",
				actor = __getnode__(_root, "Se_Story_Chapter_18_19"),
				args = function (_ctx)
					return {
						isLoop = false
					}
...
local function story18_1a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story18_1a",
					scene = scene_story18_1a
				}
			end
		})
	})
