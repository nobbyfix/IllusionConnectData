...
module("storysandbox.story04_2a")
setmetatable(_M, {
	__index = __story_sandbox__
})

local scene_story04_2a = {
	actions = {}
}
scenes.scene_story04_2a = scene_story04_2a

function scene_story04_2a:stage(args)
	return {
		name = "root",
		type = "Stage",
		id = "root",
		...
		children = {
			...
			{
				id = "Se_Story_Bubbling",
				fileName = "Se_Story_Bubbling",
				type = "Sound"
			},
			{
				id = "Se_Story_Puppet_Creak",
				fileName = "Se_Story_Puppet_Creak",
				type = "Sound"
			},
			{
				id = "Mus_Story_Memory",
			...
			{
				id = "Voice_Story_CLMan_09",
				fileName = "Voice_Story_CLMan_09",
				type = "Sound"
			},
			{
				id = "Voice_Story_CLMan_10",
				fileName = "Voice_Story_CLMan_10",
				type = "Sound"
			},
			{
				id = "Voice_Story_ZTXChang_13",
				fileName = "Voice_Story_ZTXChang_13",
				type = "Sound"
			},
			{
			...
			{
				id = "Voice_Story_PNCao_01",
				fileName = "Voice_Story_PNCao_01",
				type = "Sound"
			},
			{
				id = "Voice_Story_PNCao_02",
				fileName = "Voice_Story_PNCao_02",
				type = "Sound"
			},
			{
				id = "Voice_Story_PNCao_03",
				fileName = "Voice_Story_PNCao_03",
				type = "Sound"
			}
		},
...
function scene_story04_2a.actions.start_story04_2a(_root, args)
	return sequential({
		act({
			action = "activateNode",
		...
		concurrent({
			act({
				action = "updateNode",
				actor = __getnode__(_root, "MOGJiang_speak3"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_CLMan_09")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_CLMan_10")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		concurrent({
			act({
				action = "play",
				actor = __getnode__(_root, "Voice_Story_ZTXChang_13")
			}),
			act({
				action = "speak",
				actor = __getnode__(_root, "dialogue"),
		...
		concurrent({
			act({
				action = "updateNode",
				actor = __getnode__(_root, "MOGJiang_speak1"),
				args = function (_ctx)
					return {
						opacity = 0
					}
			...
			act({
				action = "updateNode",
				actor = __getnode__(_root, "MOGJiang_speak2"),
				args = function (_ctx)
					return {
						opacity = 0
					}
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Se_Story_Bubbling")
		}),
		act({
			action = "rock",
			actor = __getnode__(_root, "MOGJiang_speak2"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_PNCao_01")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_PNCao_02")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
		...
		act({
			action = "play",
			actor = __getnode__(_root, "Voice_Story_PNCao_03")
		}),
		act({
			action = "speak",
			actor = __getnode__(_root, "dialogue"),
...
local function story04_2a(args)
	return sequential({
		enterScene({
			args = function (_ctx)
				return {
					action = "start_story04_2a",
					scene = scene_story04_2a
				}
			end
		})
	})
