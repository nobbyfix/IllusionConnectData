...
function scene_story16_3a.actions.start_story16_3a(_root, args)
	return sequential({
		...
		act({
			...
			args = function (_ctx)
				return {
					name = "dialog_speak_name_230",
					dialogImage = "jq_dialogue_bg_1.png",
					location = "left",
					pathType = "STORY_ROOT",
					speakings = {
						"FTLEShi_speak,ZTXChang_speak,CLMan_speak"
					},
					content = {
						"story16_3a_1"
					},
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "FTLEShi/FTLEShi/FTLEShi_face_9.png",
					pathType = "STORY_FACE"
				}
			end
		}),
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "FTLEShi/FTLEShi/FTLEShi_face_7.png",
					pathType = "STORY_FACE"
				}
			end
		}),
		...
		act({
			...
			args = function (_ctx)
				return {
					resType = 0,
					image = "FTLEShi/FTLEShi/FTLEShi_face_12.png",
					pathType = "STORY_FACE"
				}
			end
		}),
