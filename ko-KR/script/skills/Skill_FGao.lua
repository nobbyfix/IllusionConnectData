...
all.Skill_FGao_Proud = {
	...
	main = function (_env, externs)
		...
		exec["@time"]({
			...
			local shield = global.ShieldEffect(_env, global.min(_env, maxHp * this.ShieldFactor, atk * 1.5))
...
all.Skill_FGao_Unique = {
	...
	main = function (_env, externs)
		...
		exec["@time"]({
			...
			local shield = global.ShieldEffect(_env, global.min(_env, maxHp * this.ShieldFactor, atk * 4))
...
all.Skill_FGao_Passive = {
	...
	passive1 = function (_env, externs)
		...
		exec["@time"]({
			...
			local maxHp = global.UnitPropGetter(_env, "maxHp")(_env, _env.ACTOR)
			local atk = global.UnitPropGetter(_env, "atk")(_env, _env.ACTOR)
			local shield = global.ShieldEffect(_env, global.min(_env, maxHp * this.ShieldFactor, atk * 1))
