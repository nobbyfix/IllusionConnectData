...
all.EquipSkill_Weapon_15110_1 = {
	...
	passive1 = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.SelectBuffCount(_env, _env.primTrgt, "EquipSkill_Weapon_15110_1_UnHurt") < 5 then
...
all.EquipSkill_Weapon_15117_2 = {
	...
	passive1 = function (_env, externs)
		...
		exec["@time"]({
			...
			local buffeft2 = global.NumericEffect(_env, "+maxHp", {
				"+Normal",
				"+Normal"
			}, this.MaxHpFactor)
	...
	passive = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.GetSide(_env, _env.unit) == global.GetSide(_env, _env.ACTOR) and global.PETS - global.SUMMONS(_env, _env.unit) then
				...
				global.print(_env, "111========================", global.UnitPropGetter(_env, "hurtrate")(_env, _env.ACTOR))
				global.print(_env, "222========================", global.UnitPropGetter(_env, "unhurtrate")(_env, _env.ACTOR))
			end
		end)
	...
	passive = function (_env, externs)
		...
		exec["@time"]({
			...
			if global.SpecialPropGetter(_env, "EquipSkill_Boots_15108_2_times")(_env, global.FriendField(_env)) < 3 and global.ProbTest(_env, this.RateFactor) and global.INSTATUS(_env, "EquipSkill_Boots_15108_2")(_env, _env.ACTOR) then
				...
				global.DelayCall(_env, 667, global.ReviveByUnit, _env.ACTOR, 1, 0, {
					setLoction
				})
